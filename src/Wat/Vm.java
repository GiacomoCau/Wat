...
public class Vm {
	...
	class Colon implements Combinable {
		...
		public Object combine(Env e, List o) {
			...
			if (chk instanceof Suspension s) return s;
			if (!(chk instanceof Integer len0) || (b ? len0 < 2 : len0 != 2)) return resumeError(chk, and("Integer (>= 2)"));
	...
	Env vmEnv() {
		...
		return (Env) vmEnv.apply(
			list(keyword(":cnt"),
				...
				"read1", wrap(new JFun("Read1", (n,o)-> checkR(n, o, 0, 1, Integer.class), (l,o)-> uncked(()-> bc2expr(new Parser(System.in, "UTF-8").expr())) )),
				"read2", wrap(new JFun("Read2", (n,o)-> checkR(n, o, 0, 1, Integer.class), (l,o)-> uncked(()-> bc2expr(parser.expr())) )),
