	...
	Env vmEnv() {
		...
		return (Env) vmEnv.apply(
			list(keyword(":cnt"),
				...
				"%csr", wrap(new JFun("%Csr", (n,o)-> checkN(n, o, 2, Cons.class, Symbol.class), (l,o)-> o.<Cons>car().cxr(o.<Symbol>car(1).name) )),
				"%csr", wrap(new JFun("%Csr", (n,o)-> checkN(n, o, 2, Cons.class, or(Symbol.class, String.class)), (l,o)-> o.<Cons>car().cxr(apply(a-> a instanceof Symbol s ? s.name : (String) a, o.car(1))) )),		
				"%cxr", wrap(new JFun("%Cxr", (n,o)-> checkN(n, o, 2, Cons.class, or(Integer.class, String.class, Symbol.class)), (l,o)-> ((ArgsList) at("cxr")).apply(list(o.car(), apply(a-> a instanceof Symbol s ? s.name : a, o.car(1)) )) )),
				...
				"%name", wrap(new JFun("%Name", (n,o)-> checkN(n, o, 1, Intern.class), (l,o)-> o.<Intern>car().name )),
				// Equals
