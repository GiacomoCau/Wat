...
(%assert (%def a 1 2) &Wat.Vm$Error :type 'type :datum 1 :expected '(or () #inert :rhs :prv :obj))
...
(%if (ctApv)
  (%begin 
    ...
    (%assert (%catchTagWth #_ #_ (%\ () (%def x 0) (%loop (%begin (%if (%== x 10) (%throwTag #_) (%def x (%+ x 1))))))) #inert)
    (%assert (%catchTagWth #_ #_ (%\ () (%def x 0) (%loop (%begin (%if (%== x 10) (%throwTag #_ x) (%def x (%+ x 1))))))) 10)
    (%assert (%catchTagWth #_ #_ (%\ () (%def x 0) (%loop (%if (%== x 10) (%throwTag #_ x) (%def x (%+ x 1)))))) 10)
    (%assert (%catchTagWth #_ #_ (%\ () (%def x 0) (%loop (%if (%== x 10) (%throwTag #_ x)) (%def x (%+ x 1))))) 10) )
