...
(def\ (instance cls . args) (apply (cls :new) args)) 
...
(defVau (class extend . bindings) env
  ...
  (def class (object static env))
  (class :cnt :new  
   (\ args
     (def obj ((object bindings class) :cnt :static class))
     (def new (@remove (.map obj) "new"))
     (if (null? new)
       (let1 (super (if (null? extend) env (instance (eval extend class))))
         ;(.parent (obj :cnt :this obj :super super) super)
         (.parent class super) (obj :cnt :this obj :super super) )
       (let1\ (noThis args (error "this not yet defined!"))
         (if (null? extend)
           (obj :this obj :super env)
           (obj :this noThis :super
             (\ args
               (def super (apply instance (cons (eval extend class) args) class))
               ;(.parent (obj :cnt :this obj :super super) super)
               (.parent class super) (obj :cnt :this obj :super super) )))
