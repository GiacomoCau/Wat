...
; #:
(assert ((\ (a) #: (> 1) a) 0) Error @getMessage "not a (> 1): 0 is returning from {%Opv (a) #ignore #: (> 1) a}")
(assert ((\ (a) #: (and Integer (> 1)) a) 0) Error @getMessage "not a (and Integer (> 1)): 0 is returning from {%Opv (a) #ignore #: (and Integer (> 1)) a}")
